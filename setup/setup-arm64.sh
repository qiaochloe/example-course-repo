...
mkdir -p /usr/0300/x86_64-linux-gnu/bin
for i in addr2line c++filt cpp-13 g++-11 gcc-13 gcov-13 gcov-dump-13 gcov-tool-13 size strings; do
  ln -sf /usr/bin/x86_64-linux-gnu-$i /usr/0300/x86_64-linux-gnu/bin/$i
done &&
  ln -sf /usr/bin/x86_64-linux-gnu-cpp-11 /usr/0300/x86_64-linux-gnu/bin/cpp &&
  ln -sf /usr/bin/x86_64-linux-gnu-g++-11 /usr/0300/x86_64-linux-gnu/bin/c++ &&
  ln -sf /usr/bin/x86_64-linux-gnu-g++-11 /usr/0300/x86_64-linux-gnu/bin/g++ &&
  ln -sf /usr/bin/x86_64-linux-gnu-gcc-11 /usr/0300/x86_64-linux-gnu/bin/gcc &&
  ln -sf /usr/bin/x86_64-linux-gnu-gcc-11 /usr/0300/x86_64-linux-gnu/bin/cc &&
  ln -sf /usr/bin/gdb-multiarch /usr/0300/x86_64-linux-gnu/bin/gdb
